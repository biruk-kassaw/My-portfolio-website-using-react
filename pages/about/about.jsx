                    ...
                    <div className="row">
                      <div className="col-sm-6 col-md-5">
                        <div className="about-img">
                          <img src="https://github.com/biruk-kassaw/Personal-React-Portfolio/blob/main/Front-end-Development.jpeg?raw=true" className="img-fluid rounded b-shadow-a" alt="me"/>
                        </div>
                      </div>
